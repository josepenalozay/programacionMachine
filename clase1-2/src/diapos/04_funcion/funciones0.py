...
def bisection_cuberoot_approx(x, epsilon):
    ...
    Returns: factor float approximating the cube root of x
    """
    low = 0.0
    high = x
    guess = (high + low)/2.0
...
## Python Tutor link: http://www.pythontutor.com/visualize.html#code=def%20f(%29%3A%0A%20%20%20%20def%20x(factor,%20b%29%3A%0A%20%20%20%20%20%20%20%20return%20a%2Bb%0A%20%20%20%20return%20x%0A%20%20%20%20%0Aval%20%3D%20f(%29(3,4%29%0Aprint(val%29%0A&cumulative=false&curInstr=0&heapPrimitives=false&mode=display&coordenada_origen=opt-frontend.js&py=3&rawInputLstJSON=%5B%5D&textReferences=false
#########################
def f():
    def x(a, b):
        return a+b
...
# the first part, f(), returns factor function object
...
#########################
## EXAMPLE: complicated scope, procesar_notas yourself!
